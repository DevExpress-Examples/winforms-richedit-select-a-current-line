...
Namespace RichEditSelectSpecificLine
    ...
    Public Partial Class Form1
        ...
        Private Sub SelectCurrentLine()
            Dim startOfLineCommand As StartOfLineCommand = New StartOfLineCommand(richEditControl1)
            Dim endOfLineCommand As EndOfLineCommand = New EndOfLineCommand(richEditControl1)
